               ...
               <?php include('includes/sidebar_nav_portfolio.php'); ?>
				<div class="span8 margin_main_container">
					<div class="title_bkgd">
						<h1>St. Mary’s Hospital Expansion</h1>
					</div>
					<img src="img/portfolio/content/st-mary-expansion.png" class="main_picture" alt="St Mary's Hospital Expansion Main Picture">
					<p>
