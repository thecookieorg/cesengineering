            ...
            <div class="row animated fadeInLeft">
				...
				<div class="span6 margin_main_container">
					<div class="title_bkgd">
						...
						<a href="mailto:kbigourdin@cesgroup.ca" style="float: right;">kbigourdin@cesgroup.ca</a><br>
					...
					<div class="position: absolute; float: left;">
						<img src="img/people/kyle.png" style="margin-top: -35px;" alt="Kyle Bigourdin CES Engineering">
					</div>
					
					<div style="border-top: 1px solid grey; border-bottom: 1px solid grey;margin-top: 10px;"><strong>KYLE BIGOURDIN</strong> :: P.Eng., CMVP, LEED AP BD+C :: ASSOCIATE</div>
					<div style="border-bottom: 1px solid grey; float: right;"></div>
					<p style="margin-top: 2px;">
					Kyle Bigourdin is a senior project engineer with specialty in managing and administrating the building systems commissioning process. As a LEED Accredited Professional with Building Design + Construction specialization, Kyle has an in-depth knowledge of the LEED process commissioning requirements.
					<br>
					<br>
