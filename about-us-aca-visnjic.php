            ...
            <div class="row animated fadeInLeft">
				...
				<div class="span6 margin_main_container">
					<div class="title_bkgd">
						...
						<a href="mailto:avisnjic@cesgroup.ca" style="float: right;">avisnjic@cesgroup.ca</a><br>
						<span style="float: right;">Connect: <a href="http://ca.linkedin.com/pub/aleksandar-atza-visnjic/9/605/764" target="_blank" style="text-decoration: none;"><span style="color: #3c9cd6;">LinkedIn</span></a></span>
					
					
					<div class="position: absolute; float: left;">
						<img src="img/people/aca.png" style="margin-top: -35px;" alt="Aleksandar Atza Visnjic CES Engineering">
					</div>
					
					<div style="border-top: 1px solid grey; border-bottom: 1px solid grey;margin-top: 10px;"><strong>ALEKSANDAR VISNJIC</strong> ::  :: </div>
