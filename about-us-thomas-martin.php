            ...
            <div class="row animated fadeInLeft">
				...
				<div class="span6 margin_main_container">
					<div class="title_bkgd">
						...
						<a href="mailto:tmartin@cesgroup.ca" style="float: right;">tmartin@cesgroup.ca</a><br>
					...
					<div class="position: absolute; float: left;">
						<img src="img/people/tom.png" style="margin-top: -35px;" alt="Thomas Martin CES Engineering">
					</div>
					
					<div style="border-top: 1px solid grey; border-bottom: 1px solid grey;margin-top: 10px;"><strong>THOMAS MARTIN</strong> :: EIT, LEED AP BD+C :: ASSOCIATE</div>
